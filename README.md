...
1. How to display a Posthog survey in a React and TypeScript app.
...
Look up [My app](https://posthog-movie-app.netlify.app/) and click the **Posthog Query API** button. It pulls movies from my Google Sheet usign the Posthog API and displays films about [Hedgehogs](https://posthog.com/blog/drawing-hedgehogs)!
...
4.  **Set up your Backend project**
    This can be done in a number of of ways, but I recommend creating a simple [Netlify](https://www.netlify.com/) function. You can see my [backend code by clicking here](https://github.com/JamieDawson/posthog-backend-movie-app)
